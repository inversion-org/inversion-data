...
namespace Inversion.Data.Store
{
    ...
    public class SqlStore : StoreBase, ISqlStore
    {
        ...
        public IsolationLevel PreferredIsolationLevel
        {
        ...
        {
            foreach (IDbDataParameter parm in parms.Where(parm => parm.Value == null))
            {
        ...
        {
            _transaction = _connection.BeginTransaction(_preferredIsolationLevel);
        }
        ...
        public virtual void Exec(string sql)
        {
            using (IDbCommand command = this.CreateCommand(sql))
            {
                ...
                catch(Exception ex)
                {
                    ...
                    throw new StoreProcessException(ex.Message, ex);
                }
            }
        }
